...
import verifsection from "../assets/verifsection.jpg"
import verif from "../assets/verif.jpg"
...
function VerificationResi(props) {
  const guarantee = [
  ...
  return (
    <div className="text-black w-full h-full max-w-[1000px] m-auto sm:w-full no-scrollbar overflow-y-scroll">
        <div
         ...
         style={{
         backgroundImage: `url(${verifsection})`,
        ...
        <div className="p-2 mb-5 flex flex-col lg:flex-row justify-around items-center">
          ...
          {props.lang?"Chez Plomberie Adican, nous comprenons l’importance d’une plomberie résidentielle fiable. C’est pourquoi notre service de Vérification Résidentiel est conçu pour assurer la tranquillité d’esprit de nos clients. Nos experts effectuent des inspections détaillées, utilisant les dernières technologies pour détecter tout problème potentiel, des fuites mineures aux dysfonctionnements majeurs. Faites confiance à Plomberie Adican pour maintenir votre système de plomberie en parfait état.":"At Adican Plumbing, we understand the importance of reliable residential plumbing. That’s why our Residential Verification service is designed to provide our clients with peace of mind. Our experts carry out detailed inspections, using the latest technologies to detect any potential issues, from minor leaks to major malfunctions. Trust Adican Plumbing to keep your plumbing system in perfect condition."}
            <ul>
                <br />
...
export default VerificationResi