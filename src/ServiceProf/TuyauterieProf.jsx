...
import TuyauterieProff from "../assets/TuyauterieProf.jpg"
import TuyauterieProfSection from "../assets/TuyauterieProfSection.jpg"
  ...
  return (
    <div className="text-black w-full h-full max-w-[1000px] m-auto sm:w-full no-scrollbar overflow-y-scroll">
        <div
         ...
         style={{
         backgroundImage: `url(${TuyauterieProfSection})`,
        ...
        >
          <div className="w-full h-28 sm:h-48 lg:h-64 flex justify-center ">
            <h1 className="text-white text-3xl md:text-5xl font-semibold h-full flex items-center text-center">
                {props.lang?"Tuyauterie Professionnelle":"Professional Piping"}
            </h1>
          </div>
        </div>
        <div className="p-2 mb-5 flex flex-col lg:flex-row justify-around items-center">
          <p className="p-2 w-full lg:w-[50%] mb-6">
          {props.lang?"La Tuyauterie Professionnelle est un domaine où Plomberie Adican excelle, offrant des services impeccables pour les environnements commerciaux et industriels. Notre équipe d’experts est équipée pour gérer des projets de grande envergure, assurant l’installation, la maintenance et la réparation de tuyauteries conçues pour répondre aux exigences spécifiques de chaque client. Nous nous engageons à fournir des solutions de tuyauterie durables et efficaces, qui soutiennent le bon fonctionnement de votre activité professionnelle.": "Professional Piping is a field where Adican Plumbing excels, offering impeccable services for commercial and industrial environments. Our team of experts is equipped to handle large-scale projects, ensuring the installation, maintenance, and repair of piping systems designed to meet the specific requirements of each client. We are committed to providing durable and efficient piping solutions that support the smooth operation of your professional activity."}            
            <ul>
                <br />
                <p className='text-2xl font-medium'>{props.lang?"Nos":"Our"} Services</p>
                <br />
                <li>&#8226; {props.lang?"Installation de Tuyauterie pour Grandes Surfaces":"Piping Installation for Large Areas"}</li>
