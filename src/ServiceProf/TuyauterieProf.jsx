        ...
        >
          <div className="w-full h-28 sm:h-48 lg:h-64 flex justify-center ">
            <h1 className="text-white text-3xl md:text-5xl font-semibold h-full flex items-center text-center">
                Tuyauterie Professionnelle
            </h1>
          </div>
        </div>
        <div className="p-2 mb-5 flex flex-col lg:flex-row justify-around items-center">
          <p className="p-2 w-full lg:w-[50%] mb-6">
          La Tuyauterie Professionnelle est un domaine où Plomberie Adican excelle, offrant des services impeccables pour les environnements commerciaux et industriels. Notre équipe d’experts est équipée pour gérer des projets de grande envergure, assurant l’installation, la maintenance et la réparation de tuyauteries conçues pour répondre aux exigences spécifiques de chaque client. Nous nous engageons à fournir des solutions de tuyauterie durables et efficaces, qui soutiennent le bon fonctionnement de votre activité professionnelle.            
            <ul>
                <br />
                <p className='text-2xl font-medium'>Nos Service</p>
                <br />
                <li>&#8226; Installation de Tuyauterie pour Grandes Surfaces</li>
                <li>&#8226; Maintenance Industrielle et Commerciale</li>
                <li>&#8226; Réparation de Tuyauterie Haute Résistance</li>
                <li>&#8226; Mises à Niveau et Modernisation</li>
                <li>&#8226; Inspections et Diagnostics Avancés</li>
                <li>&#8226; et Plus!</li>
          </ul>
        </p>
          <img 
