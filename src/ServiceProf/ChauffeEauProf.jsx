        ...
        >
          <div className="w-full h-28 sm:h-48 lg:h-64 flex justify-center ">
            <h1 className="text-white text-3xl md:text-5xl font-semibold h-full flex items-center text-center">
              Chauffe-Eau Professionnelle
            </h1>
          </div>
        </div>
        <div className="p-2 mb-5 flex flex-col lg:flex-row justify-around items-center">
          <p className="p-2 w-full lg:w-[50%] mb-6">
          Plomberie Adican excelle dans les services de Chauffe-Eau Professionnel, offrant une gamme complète de solutions pour les secteurs commerciaux et industriels. De la maintenance préventive à l’installation de nouveaux équipements, notre équipe assure un service impeccable pour garantir la performance et la fiabilité de vos systèmes de chauffe-eau. Nous nous engageons à fournir une eau chaude constante, répondant aux besoins exigeants de votre activité professionnelle.            
            <ul>
                <br />
                <h1 className='text-2xl font-medium'>Nos Service</h1>
                <br />
                <li>&#8226; Installation de Systèmes de Chauffe-Eau </li>
                <li>&#8226; Maintenance Préventive et Corrective</li>
                <li>&#8226; Mise à Niveau Technologique </li>
                <li>&#8226; Inspections de Sécurité Régulières</li>
                <li>&#8226; Conseils d’Experts en Énergie Thermique</li>
                <li>&#8226; et Plus!</li>
          </ul>
        </p>
          <img 
