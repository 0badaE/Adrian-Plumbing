    ...
    <div className="text-black w-full h-full max-w-[1000px] m-auto sm:w-full no-scrollbar overflow-y-scroll">
        ...
        <div className="p-2 mb-5 flex flex-col lg:flex-row justify-around items-center">
          <p className="p-2 w-full lg:w-[50%] mb-6">
            La Vérification Professionnelle chez Plomberie Adican est synonyme de confiance et d’excellence. Nos services sont spécialement conçus pour répondre aux besoins des entreprises commerciales et industrielles, assurant ainsi la conformité et la performance de leurs systèmes de plomberie. Nous utilisons des méthodes d’inspection rigoureuses et des technologies de pointe pour offrir des résultats fiables et précis.        
            <ul>
                <br />
                <h1 className='text-2xl font-medium'>Nos Service</h1>
                <br />
                <li>&#8226; Inspections Réglementaires et Conformité</li>
                <li>&#8226; Utilisation de Technologies de Diagnostic Avancées</li>
                <li>&#8226; Rapports Détaillés pour Assurance</li>
                <li>&#8226; Évaluations Préventives et Diagnostics</li>
                <li>&#8226; Conseils d’Experts sur l’Entretien</li>
                <li>&#8226; et Plus!</li>
            </ul>
        </p>
          <img 
